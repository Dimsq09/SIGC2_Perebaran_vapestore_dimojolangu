...
map.getView().fit([12536182.924412, -888225.456832, 12542304.702673, -885114.689041], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">peta persebaran vapestore di kelurahan mojolangu</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (102 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini menyajikan informasi tentang persebaran vapestore yang ada di kelurahan mojolangu kota malang';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_ADMINISTRASI_LN_25K_3,
    colName: 'NAMOBJ',
    zoom: 10,
    collapsed: true,
    map: map,
