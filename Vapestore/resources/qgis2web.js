...
map.getView().fit([12536460.749664, -887153.032147, 12539412.750572, -885598.170320], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Persebaran vapestore di mojolangu</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (119 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini berfungsi untuk mengetahui 10 lokasi akurat persebaran vapestore yang ada pada kelurahan mojolangu kota malang';
            }
